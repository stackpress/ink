...
`)),i?k=k.trim():d?k=k.replace(/^\s+/,""):h&&(k=k.replace(/\s+$/,""));let C=D=>{if(!k)return;let _=Vt.default.highlight(k,Vt.default.languages[r],r);if(D.detail.target.innerHTML=_,s){let S=_.match(/\n(?!$)/g),o=S?S.length+1:1,c=new Array(o+1).join("<span></span>"),p=document.createElement("span");p.setAttribute("aria-hidden","true"),p.className="line-numbers-rows",p.innerHTML=c,D.detail.target.appendChild(p)}};return()=>[I.default.createElement("link",{rel:"stylesheet",href:"https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism.min.css"}).element,I.default.createText(`
`,!1),I.default.createElement("link",{rel:"stylesheet",href:"https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism-tomorrow.min.css"}).element,I.default.createText(`
`,!1),...r==="bash"?[I.default.createText(`
  `,!1),I.default.createElement("div",{class:"terminal"},[I.default.createElement("span",{},[I.default.createText("$",!1)]).element,I.default.createText(" ",!1),...this._toNodeList(E)]).element,I.default.createText(`
`,!1)]:k?[,I.default.createText(`
  `,!1),...s?[I.default.createText(`
    `,!1),I.default.createElement("pre",{class:"snippet line-numbers"},[I.default.createElement("code",{mount:C},[]).element]).element,I.default.createText(`
  `,!1)]:[,I.default.createText(`
    `,!1),I.default.createElement("pre",{class:"snippet pad"},[I.default.createElement("code",{mount:C},[]).element]).element,I.default.createText(`
  `,!1)],I.default.createText(`
`,!1)]:[,I.default.createText(`
  `,!1),I.default.createElement("span",{},[I.default.createText("????",!1)]).element,I.default.createText(`
`,!1)],I.default.createText(`

`,!1)]}};var K=v(le());var Ie={Asset:{type:{kind:"property",list:!1,type:["text/html","text/javascript","text/css","text/plain"],description:"The MIME type of the build file asset"},content:{kind:"property",list:!1,type:"string",description:"The source code of the build file asset."}},Path:{path:{kind:"property",list:!1,type:"string",description:"The file path",example:"'/path/to/file'"},type:{kind:"property",list:!1,type:"string",description:"The type of path.",example:"'file'"}},Config:{brand:{kind:"property",list:!1,type:"string",description:"The brand prefixed before the component tag name.",example:"'ink'"},cwd:{kind:"property",list:!1,type:"string",description:"The project's current working directory (cwd).",example:"'/path/to/project'"},fs:{kind:"property",list:!1,type:"FileSystem",description:"The file system being used to read/write files.",example:`import fs from 'fs';
...
app.engine('ink', view(compiler));`}}};var ce=class extends zr.default{static id="f20d8dbea11e7ab3e760";static tagname="ui";static classname="Ui_f20d8dbea11e7ab3e760";styles(){return""}template(){(0,K.classlist)().add("block","my-40","scroll-hidden","curved","shadow-0-0-10-0-0-0-5");let{start:t="InkCompiler"}=(0,K.props)(),r=(0,K.signal)([t]),s=(0,K.signal)(t),a=d=>{let h=d.target.getAttribute("data-type");r.value=[...r.value,h],s.value=h},i=()=>{r.value=r.value.slice(0,r.value.length-1),s.value=r.value[r.value.length-1]};return()=>[l.default.createText(`
  ...
  `,!1),l.default.createElement("div",{class:"relative mb-20 scroll-auto"},[l.default.createText(`
    `,!1),l.default.createElement("table",{class:"w-full b-collapse"},[l.default.createText(`
      ...
      `,!1),l.default.createElement("tbody",{},[l.default.createText(`
        `,!1),...Object.entries(Ie[s.value]).map(([d,h])=>[l.default.createText(`
          `,!1),l.default.createElement("tr",{},[l.default.createText(`
            `,!1),...h.kind==="property"?[l.default.createText(`
              ...
              `,!1)]).element,l.default.createText(`
              `,!1),...Ie[h.type]?[l.default.createText(`
            ...
            `,!1)]:h.kind==="function"?[,l.default.createText(`
              `,!1),l.default.createElement("td",{class:"tx-primary tx-top b-solid b-t-2 bx-0 bb-0 bt-1 p-10",nowrap:!0},[l.default.createText(`
                `,!1),...this._toNodeList(d),l.default.createText(`(
                  `,!1),...Object.entries(h.args).map(([T,E])=>[l.default.createText(`
                    ...
                    `,!1),...Ie[E.type]?[l.default.createText(`
              ...
              `,!1)]).element,l.default.createText(`
              `,!1),...Ie[h.returns.type]?[l.default.createText(`
                `,!1),l.default.createElement("td",{class:"tx-top tx-nowrap b-solid b-t-2 bx-0 bb-0 bt-1 p-10"},[l.default.createText(`
    ...
    `,!1)]).element,l.default.createText(`
  `,!1)]).element,l.default.createText(`
`,!1)]).element]}};var N=v(j()),Gr=v(B()),nt=v(le()),pe=class extends Gr.default{static id="d640748373b32ef31882";static tagname="app";static classname="App_d640748373b32ef31882";styles(){return""}template(){let{title:t,height:r}=(0,nt.props)(),s=r?`height:${r}px`:"";return()=>[N.default.createText(`
...
`,!1)]).element]}};var q=v(j()),Jr=v(B());var y=function(n,...t){let r=Yt(n);for(let s=0;s<t.length;s++)r=r.replace("%s",String(t[s]));return r},Yt=function(n){return n};var de=class extends Jr.default{static id="ac78a9f3111e4c80978c";static tagname="translate";static classname="Translate_ac78a9f3111e4c80978c";styles(){return""}template(){let{trim:t=!1,p:r=!1,li:s=!1,div:a=!1}=this.props,i=this.originalChildren,d=[],h=[];for(let C of i)typeof C=="string"?d.push(C):C instanceof Node&&C.textContent?d.push(C.textContent):(d.push("%s"),h.push(C));let T=d.join("");t&&(T=T.replace(/\s+/," ").trim());let E=Yt(T).split("%s"),k=[];for(let C=0;C<E.length;C++)k.push(document.createTextNode(E[C])),h[C]&&k.push(h[C]);return()=>[q.default.createText(`
...
`,!1),e.default.createElement("html",{},[e.default.createText(`
  ...
  `,!1),e.default.createElement("link",{rel:"stylesheet",type:"text/css",href:`/ink/client/${(0,st.env)("BUILD_ID")}.css`}),e.default.createElement("script",{"data-template":!0,type:"text/json"},[e.default.createText("__TEMPLATE_DATA__",!0)]),e.default.createText(`
  `,!1),e.default.createElement("script",{src:`/ink/client/${(0,st.env)("BUILD_ID")}.js`}),e.default.createText(`
...
`,!1)])]),e.default.createText(`
    ...
    `,!1)]),e.default.createText(`
  `,!1)]),e.default.createText(`
`,!1)])]}},Is={PanelLayout_79d31ab9c2a1621f9a22:ee,ElementAlert_9d0f5af137a9d2a0b02a:re,ElementIcon_e084b6924e0478588e54:ne,ApiDocs_3e2f9d1245032407693b:oe,ApiUi_f20d8dbea11e7ab3e760:ce,ApiIdeCode_07bacf6bf1ae49080e95:U,IdeApp_d640748373b32ef31882:pe,IdeCode_07bacf6bf1ae49080e95:U,I18nTranslate_ac78a9f3111e4c80978c:de},Zr={"panel-layout":ee,"element-alert":re,"element-icon":ne,"api-docs":oe,"api-ui":ce,"ide-app":pe,"ide-code":U,"i18n-translate":de},Ls="605de97da06380306d81";at.default.once("ready",()=>{it.sync();for(let[n,t]of Object.entries(Zr))customElements.getName(t)||customElements.define(n,t);at.default.emit("mounted",document.body)});return on(Ns);})();
