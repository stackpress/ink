...
`,!1)]).element]}};var Xe=v(F()),mr=v(I()),pr=v(we()),gr=v(fr()),br=v(dr()),xr=v(hr()),re=class extends mr.default{static id="e084b6924e0478588e54";static tagname="icon";static classname="Icon_e084b6924e0478588e54";styles(){return""}template(){let{name:e,solid:r,brand:a}=this.props,n=new pr.default;this.styles=()=>n.toString(),(0,br.default)(this.props,n,"inline-block",":host"),(0,gr.default)(this.props,n,!1,":host","color"),(0,xr.default)(this.props,n,!1,":host","font-size");let i=["fa-fw",`fa-${e}`];return i.push(a?"fa-brands":"fa-solid"),()=>[Xe.default.createElement("link",{rel:"stylesheet",type:"text/css",href:"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css"}).element,Xe.default.createText(`
`,!1),Xe.default.createElement("i",{class:i.join(" ")},[]).element]}};var Vt=v(F()),$r=v(I()),st=v(Y()),ie=class extends $r.default{static id="3e2f9d1245032407693b";static tagname="docs";static classname="Docs_3e2f9d1245032407693b";styles(){return""}template(){return(0,st.classlist)().add("block","w-full","h-full","scroll-y-auto","scroll-x-hidden"),()=>[Vt.default.createText(`
`,!1),Vt.default.createElement("article",{class:"block p-10 tx-t-1"},[...this._toNodeList((0,st.children)())]).element]}};var Se=v(F()),Ur=v(I()),at=v(Y()),le=class extends Ur.default{static id="d33baebe90a860722627";static tagname="head";static classname="Head_d33baebe90a860722627";styles(){return""}template(){return(0,at.classlist)().add("absolute","top-0","right-0","left-170","h-45","bg-t-0","z-1"),()=>[Se.default.createText(`
`,!1),Se.default.createElement("header",{class:"w-full h-full scroll-x-auto"},[Se.default.createText(`
  `,!1),...this._toNodeList((0,at.children)()),Se.default.createText(`
`,!1)]).element]}};var Ne=v(F()),Br=v(I()),nt=v(Y()),oe=class extends Br.default{static id="f1a0a3c183816d2e79ee";static tagname="left";static classname="Left_f1a0a3c183816d2e79ee";styles(){return""}template(){return(0,nt.classlist)().add("absolute","top-0","bottom-0","left-0","w-170","bg-t-3","b-solid","b-t-2","by-0","bl-0","br-1","z-2"),()=>[Ne.default.createText(`
...
`,!1)]).element]}};var S=v(F()),zr=v(I()),lt=v(Y()),ue=class extends zr.default{static id="d640748373b32ef31882";static tagname="app";static classname="App_d640748373b32ef31882";styles(){return""}template(){let{title:e,height:r}=(0,lt.props)(),a=r?`height:${r}px`:"";return()=>[S.default.createText(`
`,!1),S.default.createElement("div",{class:"curved scroll-hidden shadow-0-0-10-0-0-0-5"},[S.default.createText(`
  `,!1),S.default.createElement("div",{class:"relative flex flex-center-y gap-10 p-10 bg-t-1 tx-c-999999 tx-16"},[S.default.createText(`
    `,!1),S.default.createElement("span",{class:"bg-h-999999 pill h-10 w-10"},[]).element,S.default.createText(`
    `,!1),S.default.createElement("span",{class:"bg-h-999999 pill h-10 w-10"},[]).element,S.default.createText(`
    `,!1),S.default.createElement("span",{class:"bg-h-999999 pill h-10 w-10"},[]).element,S.default.createText(`
    `,!1),S.default.createElement("span",{class:"flex flex-center h-full w-full absolute top-0 left-0"},[S.default.createText(`
      `,!1),...this._toNodeList(e),S.default.createText(`
    `,!1)]).element,S.default.createText(`
  `,!1)]).element,S.default.createText(`
  `,!1),S.default.createElement("div",{class:"bg-black tx-t-1 relative",style:a},[...this._toNodeList((0,lt.children)())]).element,S.default.createText(`
`,!1)]).element]}};var D=v(F()),Wr=v(I()),Zt=v(Gr()),Yr=v(Y()),fe=class extends Wr.default{static id="07bacf6bf1ae49080e95";static tagname="code";static classname="Code_07bacf6bf1ae49080e95";styles(){return`:host {
    display: block;
    font-size: 14px;
    line-height: 20px;
  }
...
`)),i?b=b.trim():h?b=b.replace(/^\s+/,""):_&&(b=b.replace(/\s+$/,""));let A=y=>{if(!b)return;let T=Zt.default.highlight(b,Zt.default.languages[r],r);if(y.detail.target.innerHTML=T,a){let O=T.match(/\n(?!$)/g),l=O?O.length+1:1,o=new Array(l+1).join("<span></span>"),c=document.createElement("span");c.setAttribute("aria-hidden","true"),c.className="line-numbers-rows",c.innerHTML=o,y.detail.target.appendChild(c)}};return()=>[D.default.createElement("link",{rel:"stylesheet",href:"https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism.min.css"}).element,D.default.createText(`
`,!1),D.default.createElement("link",{rel:"stylesheet",href:"https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism-tomorrow.min.css"}).element,D.default.createText(`
`,!1),...r==="bash"?[D.default.createText(`
  `,!1),D.default.createElement("div",{class:"terminal"},[D.default.createElement("span",{},[D.default.createText("$",!1)]).element,D.default.createText(" ",!1),...this._toNodeList(E)]).element,D.default.createText(`
`,!1)]:b?[,D.default.createText(`
  `,!1),...a?[D.default.createText(`
    `,!1),D.default.createElement("pre",{class:"snippet line-numbers"},[D.default.createElement("code",{mount:A},[]).element]).element,D.default.createText(`
  `,!1)]:[,D.default.createText(`
    `,!1),D.default.createElement("pre",{class:"snippet pad"},[D.default.createElement("code",{mount:A},[]).element]).element,D.default.createText(`
  `,!1)],D.default.createText(`
`,!1)]:[,D.default.createText(`
  `,!1),D.default.createElement("span",{},[D.default.createText("????",!1)]).element,D.default.createText(`
`,!1)],D.default.createText(`

`,!1)]}};var q=v(F()),Vr=v(I());var k=function(s,...e){let r=Jt(s);for(let a=0;a<e.length;a++)r=r.replace("%s",String(e[a]));return r},Jt=function(s){return s};var de=class extends Vr.default{static id="ac78a9f3111e4c80978c";static tagname="translate";static classname="Translate_ac78a9f3111e4c80978c";styles(){return""}template(){let{trim:e=!1,p:r=!1,li:a=!1,div:n=!1}=this.props,i=this.originalChildren,h=[],_=[];for(let A of i)typeof A=="string"?h.push(A):A instanceof Node&&A.textContent?h.push(A.textContent):(h.push("%s"),_.push(A));let x=h.join("");e&&(x=x.replace(/\s+/," ").trim());let E=Jt(x).split("%s"),b=[];for(let A=0;A<E.length;A++)b.push(document.createTextNode(E[A])),_[A]&&b.push(_[A]);return()=>[q.default.createText(`
    ...
    `,!1)]]}};var ct=v(Y());var ft=class s extends Zr.default{static sync(){return new s().sync()}template(){let e="/docs/template-engine.html",r=k("Template Engine - Ink reactive web component template engine."),a=k("How to use Ink as a template engine."),n=()=>{document.getElementsByTagName("panel-layout")[0].toggle("left")};return[t.default.createText(`
...
`,!1)])]),t.default.createText(`
      `,!1),t.default.createElement("main",{},[t.default.createText(`
        `,!1),t.default.createElement("api-docs",{},[t.default.createText(`
          ...
          `,!1),t.default.createElement("ide-app",{height:410,title:"My Project"},[t.default.createText(`
            `,!1),t.default.createElement("app-head",{},[t.default.createText(`
              `,!1),t.default.createElement("div",{class:"flex scroll-x-auto pt-5 pl-5"},[t.default.createText(`
                `,!1),t.default.createElement("element-tab",{on:!0,class:"relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0",active:"bg-black tx-white",inactive:"bg-t-1 tx-t-1",group:"engine",selector:"#index-ts"},[t.default.createText(`
                  src/index.ts
                `,!1)]),t.default.createText(`
                `,!1),t.default.createElement("element-tab",{class:"relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0",active:"bg-black tx-white",inactive:"bg-t-1 tx-t-1",group:"engine",selector:"#page-ink"},[t.default.createText(`
                  src/page.ink
                `,!1)]),t.default.createText(`
                `,!1),t.default.createElement("element-tab",{class:"relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0",active:"bg-black tx-white",inactive:"bg-t-1 tx-t-1",group:"engine",selector:"#package-json"},[t.default.createText(`
                  package.json
                `,!1)]),t.default.createText(`
              `,!1)]),t.default.createText(`
            `,!1)]),t.default.createText(`
            `,!1),t.default.createElement("app-left",{},[t.default.createText(`
              ...
              `,!1)]),t.default.createText(`
              `,!1),t.default.createElement("element-tab",{on:!0,class:"pl-15 pt-10 block",active:"tx-white",inactive:"tx-muted",group:"engine",selector:"#index-ts"},[t.default.createText(`
                `,!1),t.default.createElement("element-icon",{name:"file"}),t.default.createText(`
                index.ts
              `,!1)]),t.default.createText(`
              `,!1),t.default.createElement("element-tab",{class:"pl-15 pt-10 block",active:"tx-white",inactive:"tx-muted",group:"engine",selector:"#page-ink"},[t.default.createText(`
                `,!1),t.default.createElement("element-icon",{name:"file"}),t.default.createText(`
                page.ink
              `,!1)]),t.default.createText(`
              `,!1),t.default.createElement("element-tab",{class:"pt-10 block",active:"tx-white",inactive:"tx-muted",group:"engine",selector:"#package-json"},[t.default.createText(`
                `,!1),t.default.createElement("element-icon",{name:"file"}),t.default.createText(`
                package.json
              `,!1)]),t.default.createText(`
            `,!1)]),t.default.createText(`
            `,!1),t.default.createElement("app-main",{},[t.default.createText(`
              ...
              `,!1),t.default.createElement("ide-code",{id:"page-ink",style:"display:none",numbers:!0,trim:!0,detab:16},[...this._toNodeList(`
                <style>
          ...
          `,!1),t.default.createElement("i18n-translate",{p:!0,trim:!0,class:"tx-lh-36 py-20"},[t.default.createText(`
            The server file 
            `,!1),t.default.createElement("ide-code",{inline:!0},[t.default.createText("src/index.ts",!1)]),t.default.createText(` 
            implements a simple server utilizing the Ink compiler in 
            its most simplistic form. The document file
            `,!1),t.default.createElement("ide-code",{inline:!0},[t.default.createText("src/page.ink",!1)]),t.default.createText(` 
            is using the most basic Ink syntax. To test the script and 
            see the results, run the following command in terminal.
          `,!1)]),t.default.createText(`
          `,!1),t.default.createElement("ide-code",{trim:!0,lang:"bash"},[t.default.createText(`
            npm run dev
          `,!1)]),t.default.createText(`
          `,!1),t.default.createElement("i18n-translate",{p:!0,trim:!0,class:"tx-lh-36 py-20"},[t.default.createText(`
            Load 
          ...
          `,!1),t.default.createElement("nav",{class:"flex"},[t.default.createText(`
            `,!1),t.default.createElement("a",{class:"tx-primary py-40",href:"/ink/docs/client-api.html"},[t.default.createText(`
              `,!1),t.default.createElement("element-icon",{name:"chevron-left",theme:"tx-1"}),t.default.createText(`
              `,!1),...this._toNodeList(k("Client API")),t.default.createText(`
            `,!1)]),t.default.createText(`
            `,!1),t.default.createElement("a",{class:"flex-grow tx-right tx-primary py-40",href:"/ink/docs/single-page.html"},[t.default.createText(`
              `,!1),...this._toNodeList(k("Single Page App")),t.default.createText(`
