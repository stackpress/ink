...
`,!1)]).element]}};var C=k(P()),$a=k(U()),zt=k(Ra()),qa=k(Ae()),ie=class extends $a.default{static id="d21b237295245a3b7d61";static tagname="code";static classname="Code_d21b237295245a3b7d61";styles(){return`:host {
    display: block;
    font-size: 14px;
    line-height: 20px;
  }
...
`,!1)])]),e.default.createText(`
    ...
    `,!1)]),e.default.createText(`
  `,!1)]),e.default.createText(`
`,!1)])]}},vs={PanelLayout_e83da818dc31723bcd5d:K,ElementAlert_502d0a1992f720baceb4:X,ElementIcon_75af7664df8b2546e65a:ee,ApiDocs_7e4942547226dfeef0ae:se,IdeApp_ab38f0e847e1d047c1a8:ne,IdeCode_d21b237295245a3b7d61:ie,I18nTranslate_b1ed083cf3561af1816f:le},Ga={"panel-layout":K,"element-alert":X,"element-icon":ee,"api-docs":se,"ide-app":ne,"ide-code":ie,"i18n-translate":le},ws="496068ab2a75d6beb9a5";tt.default.once("ready",()=>{at.sync();for(let[r,t]of Object.entries(Ga))customElements.getName(t)||customElements.define(r,t);tt.default.emit("mounted",document.body)});return ar(ks);})();
