...
`,!1)]).element]}};var L=w(q()),zr=w(Y()),it=w(de()),fe=class extends zr.default{static id="ab38f0e847e1d047c1a8";static tagname="app";static classname="App_ab38f0e847e1d047c1a8";styles(){return""}template(){let{title:e,height:r}=(0,it.props)(),s=r?`height:${r}px`:"";return()=>[L.default.createText(`
...
`,!1)]).element]}};var C=w(q()),Ur=w(Y()),Kt=w(Br()),Gr=w(de()),me=class extends Ur.default{static id="d21b237295245a3b7d61";static tagname="code";static classname="Code_d21b237295245a3b7d61";styles(){return`:host {
    display: block;
    font-size: 14px;
    line-height: 20px;
  }
...
`,!1)]}};var Vt=w(q()),Wr=w(Y()),ot=w(de()),he=class extends Wr.default{static id="e7eced4fdf7c353afd2e";static tagname="preview";static classname="Preview_e7eced4fdf7c353afd2e";styles(){return""}template(){return(0,ot.classlist)().add("block","w-full","h-full","scroll-auto"),()=>[Vt.default.createText(`
`,!1),Vt.default.createElement("div",{class:"bg-white tx-black arial p-10 h-full"},[...this._toNodeList((0,ot.children)())]).element]}};var z=w(q()),Yr=w(Y());var M=function(a,...e){let r=Qt(a);for(let s=0;s<e.length;s++)r=r.replace("%s",String(e[s]));return r},Qt=function(a){return a};var pe=class extends Yr.default{static id="b1ed083cf3561af1816f";static tagname="translate";static classname="Translate_b1ed083cf3561af1816f";styles(){return""}template(){let{trim:e=!1,p:r=!1,li:s=!1,div:n=!1}=this.props,i=this.originalChildren,f=[],_=[];for(let A of i)typeof A=="string"?f.push(A):A instanceof Node&&A.textContent?f.push(A.textContent):(f.push("%s"),_.push(A));let b=f.join("");e&&(b=b.replace(/\s+/," ").trim());let E=Qt(b).split("%s"),x=[];for(let A=0;A<E.length;A++)x.push(document.createTextNode(E[A])),_[A]&&x.push(_[A]);return()=>[z.default.createText(`
    ...
    `,!1)]]}};var S=w(q()),Jr=w(Y()),ct=w(de()),ge=class extends Jr.default{static id="c45026374ce7b5fcdb56";static tagname="tweet-box";static classname="TweetBox_c45026374ce7b5fcdb56";styles(){return`a, a:link, a:hover, a:active, a:visited {
    color: var(--info);
    text-decoration: none;
  }
  :host {
...
`,!1)])]),t.default.createText(`
    ...
    `,!1)]),t.default.createText(`
  `,!1)]),t.default.createText(`
`,!1)])]}},Os={PanelLayout_e83da818dc31723bcd5d:ne,ElementButton_616a22ffcec73844b10b:le,IdeApp_ab38f0e847e1d047c1a8:fe,IdeCode_d21b237295245a3b7d61:me,IdePreview_e7eced4fdf7c353afd2e:he,I18nTranslate_b1ed083cf3561af1816f:pe,TweetBox_c45026374ce7b5fcdb56:ge},Qr={"panel-layout":ne,"element-button":le,"ide-app":fe,"ide-code":me,"ide-preview":he,"i18n-translate":pe,"tweet-box":ge},Ns="dea00042d1164bec750f";dt.default.once("ready",()=>{ft.sync();for(let[a,e]of Object.entries(Qr))customElements.getName(e)||customElements.define(a,e);dt.default.emit("mounted",document.body)});return na(Ds);})();
