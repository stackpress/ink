...
`,!1)]).element]}};var ar=v(R()),Xr=v(F()),ct=v(G()),de=class extends Xr.default{static id="7e4942547226dfeef0ae";static tagname="docs";static classname="Docs_7e4942547226dfeef0ae";styles(){return""}template(){return(0,ct.classlist)().add("block","w-full","h-full","scroll-y-auto","scroll-x-hidden"),()=>[ar.default.createText(`
`,!1),ar.default.createElement("article",{class:"block p-10 tx-t-1"},[...this._toNodeList((0,ct.children)())]).element]}};var l=v(R()),ss=v(F());var S=v(R()),ts=v(F()),nr=v(es()),rs=v(G()),U=class extends ts.default{static id="d21b237295245a3b7d61";static tagname="code";static classname="Code_d21b237295245a3b7d61";styles(){return`:host {
    display: block;
    font-size: 14px;
    line-height: 20px;
  }
...
`,!1),l.default.createElement("div",{class:"bg-t-0 p-10"},[l.default.createText(`
  `,!1),l.default.createElement("div",{class:"relative mb-20 scroll-auto"},[l.default.createText(`
    ...
    `,!1)]).element,l.default.createText(`
  `,!1)]).element,l.default.createText(`
`,!1)]).element]}};var Pe=v(R()),as=v(F()),dt=v(G()),me=class extends as.default{static id="6db660ec31ca715d7e96";static tagname="head";static classname="Head_6db660ec31ca715d7e96";styles(){return""}template(){return(0,dt.classlist)().add("absolute","top-0","right-0","left-170","h-45","bg-t-0","z-1"),()=>[Pe.default.createText(`
...
`,!1)]).element]}};var Fe=v(R()),ns=v(F()),ut=v(G()),fe=class extends ns.default{static id="5fb4822ce248e2b6fb4f";static tagname="left";static classname="Left_5fb4822ce248e2b6fb4f";styles(){return""}template(){return(0,ut.classlist)().add("absolute","top-0","bottom-0","left-0","w-170","bg-t-3","b-solid","b-t-2","by-0","bl-0","br-1","z-2"),()=>[Fe.default.createText(`
...
`,!1)]).element]}};var je=v(R()),is=v(F()),mt=v(G()),he=class extends is.default{static id="d54fe27339c3e65ac735";static tagname="main";static classname="Main_d54fe27339c3e65ac735";styles(){return""}template(){return(0,mt.classlist)().add("absolute","top-45","right-0","left-170","bottom-0","bg-black","b-solid","b-t-2","bx-0","bb-0","bt-1"),()=>[je.default.createText(`
...
`,!1)]).element]}};var N=v(R()),ls=v(F()),ft=v(G()),ge=class extends ls.default{static id="ab38f0e847e1d047c1a8";static tagname="app";static classname="App_ab38f0e847e1d047c1a8";styles(){return""}template(){let{title:t,height:r}=(0,ft.props)(),a=r?`height:${r}px`:"";return()=>[N.default.createText(`
