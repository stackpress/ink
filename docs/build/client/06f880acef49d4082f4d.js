...
`,!1)]).element]}};var Xe=v(F()),mr=v(I()),hr=v(we()),gr=v(fr()),br=v(dr()),xr=v(pr()),re=class extends mr.default{static id="75af7664df8b2546e65a";static tagname="icon";static classname="Icon_75af7664df8b2546e65a";styles(){return""}template(){let{name:e,solid:r,brand:s}=this.props,n=new hr.default;this.styles=()=>n.toString(),(0,br.default)(this.props,n,"inline-block",":host"),(0,gr.default)(this.props,n,!1,":host","color"),(0,xr.default)(this.props,n,!1,":host","font-size");let i=["fa-fw",`fa-${e}`];return i.push(s?"fa-brands":"fa-solid"),()=>[Xe.default.createElement("link",{rel:"stylesheet",type:"text/css",href:"https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css"}).element,Xe.default.createText(`
`,!1),Xe.default.createElement("i",{class:i.join(" ")},[]).element]}};var Vt=v(F()),qr=v(I()),at=v(Y()),ie=class extends qr.default{static id="7e4942547226dfeef0ae";static tagname="docs";static classname="Docs_7e4942547226dfeef0ae";styles(){return""}template(){return(0,at.classlist)().add("block","w-full","h-full","scroll-y-auto","scroll-x-hidden"),()=>[Vt.default.createText(`
`,!1),Vt.default.createElement("article",{class:"block p-10 tx-t-1"},[...this._toNodeList((0,at.children)())]).element]}};var je=v(F()),Ur=v(I()),st=v(Y()),le=class extends Ur.default{static id="6db660ec31ca715d7e96";static tagname="head";static classname="Head_6db660ec31ca715d7e96";styles(){return""}template(){return(0,st.classlist)().add("absolute","top-0","right-0","left-170","h-45","bg-t-0","z-1"),()=>[je.default.createText(`
...
`,!1)]).element]}};var De=v(F()),Hr=v(I()),nt=v(Y()),oe=class extends Hr.default{static id="5fb4822ce248e2b6fb4f";static tagname="left";static classname="Left_5fb4822ce248e2b6fb4f";styles(){return""}template(){return(0,nt.classlist)().add("absolute","top-0","bottom-0","left-0","w-170","bg-t-3","b-solid","b-t-2","by-0","bl-0","br-1","z-2"),()=>[De.default.createText(`
...
`,!1)]).element]}};var j=v(F()),zr=v(I()),lt=v(Y()),ue=class extends zr.default{static id="ab38f0e847e1d047c1a8";static tagname="app";static classname="App_ab38f0e847e1d047c1a8";styles(){return""}template(){let{title:e,height:r}=(0,lt.props)(),s=r?`height:${r}px`:"";return()=>[j.default.createText(`
