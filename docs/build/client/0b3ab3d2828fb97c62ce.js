var InkAPI = (() => {
  ...
  // ink-document-client-resolver:/Users/cblanquera/server/projects/stackpress/ink/packages/ink-web/src/pages/docs/index.ink
  var docs_exports = {};
...
`, false),
  ...
  var Icon_a3faebb4ed7a157e1d84 = class extends import_InkComponent2.default {
    ...
    template() {
      ...
      return () => [
        import_InkRegistry2.default.createElement("link", { "rel": `stylesheet`, "type": `text/css`, "href": `https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css` }).element,
        import_InkRegistry2.default.createText(`
`, false),
        import_InkRegistry2.default.createElement("i", { "class": iconClass.join(" ") }, []).element
      ];
    }
  };
  ...
  var Docs_7e4942547226dfeef0ae = class extends import_InkComponent3.default {
...
`, false),
        import_InkRegistry3.default.createElement("article", { "class": `block p-10 tx-t-1` }, [
  ...
  var App_ab38f0e847e1d047c1a8 = class extends import_InkComponent4.default {
...
`, false),
        import_InkRegistry4.default.createElement("div", { "class": `curved scroll-hidden shadow-0-0-10-0-0-0-5` }, [
          import_InkRegistry4.default.createText(`
  `, false),
          import_InkRegistry4.default.createElement("div", { "class": `relative flex flex-center-y gap-10 p-10 bg-t-1 tx-c-999999 tx-16` }, [
            import_InkRegistry4.default.createText(`
    `, false),
            import_InkRegistry4.default.createElement("span", { "class": `bg-h-999999 pill h-10 w-10` }, []).element,
            import_InkRegistry4.default.createText(`
    `, false),
            import_InkRegistry4.default.createElement("span", { "class": `bg-h-999999 pill h-10 w-10` }, []).element,
            import_InkRegistry4.default.createText(`
    `, false),
            ...
            import_InkRegistry4.default.createText(`
    `, false),
            import_InkRegistry4.default.createElement("span", { "class": `flex flex-center h-full w-full absolute top-0 left-0` }, [
              import_InkRegistry4.default.createText(`
      `, false),
  ...
  `, false)
          ...
          import_InkRegistry4.default.createText(`
  `, false),
          import_InkRegistry4.default.createElement("div", { "class": `bg-black tx-t-1 relative`, "style": style }, [
...
`, false)
  ...
  var Code_d21b237295245a3b7d61 = class extends import_InkComponent5.default {
  ...
  .terminal span {
    ...
    template() {
      ...
      return () => [
        import_InkRegistry5.default.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism.min.css` }).element,
        import_InkRegistry5.default.createText(`
`, false),
        import_InkRegistry5.default.createElement("link", { "rel": `stylesheet`, "href": `https://cdnjs.cloudflare.com/ajax/libs/prism/9000.0.1/themes/prism-tomorrow.min.css` }).element,
        import_InkRegistry5.default.createText(`
`, false),
        ...!!(lang === "bash") ? [
          import_InkRegistry5.default.createText(`
  `, false),
          import_InkRegistry5.default.createElement("div", { "class": `terminal` }, [
            import_InkRegistry5.default.createElement("span", {}, [
              import_InkRegistry5.default.createText(`$`, false)
            ]).element,
            import_InkRegistry5.default.createText(` `, false),
...
`, false)
  ...
  `, false),
          ...!!numbers ? [
            import_InkRegistry5.default.createText(`
    `, false),
            import_InkRegistry5.default.createElement("pre", { "class": `snippet line-numbers` }, [
              import_InkRegistry5.default.createElement("code", { "mount": highlight }, []).element
            ]).element,
            import_InkRegistry5.default.createText(`
  `, false)
          ] : true ? [
            ...
            import_InkRegistry5.default.createText(`
    `, false),
            import_InkRegistry5.default.createElement("pre", { "class": `snippet pad` }, [
              import_InkRegistry5.default.createElement("code", { "mount": highlight }, []).element
            ]).element,
            import_InkRegistry5.default.createText(`
  `, false)
...
`, false)
  ...
  var Preview_e7eced4fdf7c353afd2e = class extends import_InkComponent6.default {
...
`, false),
        import_InkRegistry6.default.createElement("div", { "class": `bg-white tx-black arial p-10 h-full` }, [
  ...
  // ink-component-resolver:/Users/cblanquera/server/projects/stackpress/ink/packages/ink-web/src/components/i18n/translate.ink
  var Translate_b1ed083cf3561af1816f = class extends import_InkComponent7.default {
    ...
    `, false),
        ...!!p ? [
          import_InkRegistry7.default.createText(`
      `, false),
          import_InkRegistry7.default.createElement("p", {}, [
    ...
    `, false)
          ...
          import_InkRegistry7.default.createText(`
      `, false),
          import_InkRegistry7.default.createElement("li", {}, [
            ...this._toNodeList(translations)
          ]).element,
          import_InkRegistry7.default.createText(`
    `, false)
          ...
          import_InkRegistry7.default.createText(`
      `, false),
          import_InkRegistry7.default.createElement("div", {}, [
            ...this._toNodeList(translations)
          ]).element,
          import_InkRegistry7.default.createText(`
    `, false)
  ...
  import_InkEmitter.default.once("ready", () => {
    ...
    const __BINDINGS__ = { "2": { "class": `flex flex-center-y px-20 py-15 m-0 bg-t-1` }, "3": { "class": `fas fa-fw fa-bars cursor-pointer py-5 pr-10 none md-inline-block tx-t-1`, "click": toggle }, "4": { "class": `flex-grow` }, "5": { "class": `flex flex-center-y` }, "6": { "class": `tx-primary`, "href": `/ink/docs/index.html` }, "7": { "class": `tx-t-1 tx-5xl ml-10`, "href": `https://github.com/stackpress/ink`, "target": `_blank` }, "8": { "class": `fab fa-github` }, "9": { "class": `bg-h-cb3837 pill tx-t-1 tx-lg ml-5 p-5 tx-center`, "href": `https://www.npmjs.com/package/@stackpress/ink`, "target": `_blank` }, "10": { "class": `fab fa-npm text-white` }, "11": { "class": `bg-h-7289da pill tx-t-1 tx-lg ml-5 p-5 tx-center`, "href": `https://discord.gg/open-source-software-ph-905496362982981723`, "target": `_blank` }, "12": { "class": `fab fa-discord text-white` }, "13": { "left": true }, "14": { "class": `flex flex-center-y bg-t-2 py-15 pr-5 pl-10` }, "15": { "href": `/ink` }, "16": { "class": `h-26 mr-10`, "src": `/ink/ink-icon.png`, "alt": `Ink Logo` }, "17": { "class": `flex-grow m-0 tx-upper` }, "18": { "class": `tx-primary`, "href": `/ink` }, "19": { "class": `fas fa-fw fa-chevron-left cursor-pointer none md-inline-block`, "click": toggle }, "20": { "class": `bg-t-1 scroll-auto h-calc-full-60` }, "21": { "class": `bt-1 bt-solid bt-t-1 tx-black tx-14 mb-0 mt-0 pt-20 pb-10 pl-10 tx-upper` }, "22": { "class": `block tx-t-1 py-10 pl-10 tx-bold`, "href": `/ink/docs/index.html` }, "23": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/getting-started.html` }, "24": { "class": `bt-1 bt-solid bt-t-1 tx-black tx-14 mb-0 mt-20 pt-20 pb-10 pl-10 tx-upper` }, "25": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/markup-syntax.html` }, "26": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/state-management.html` }, "27": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/component-strategy.html` }, "28": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/compiler-api.html` }, "29": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/client-api.html` }, "30": { "class": `bt-1 bt-solid bt-t-1 tx-black tx-14 mb-0 mt-20 pt-20 pb-10 pl-10 tx-upper` }, "31": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/template-engine.html` }, "32": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/single-page.html` }, "33": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/static-site.html` }, "34": { "class": `block tx-t-1 py-10 pl-10`, "href": `/ink/docs/component-publisher.html` }, "35": { "class": `block tx-t-1 py-10 pl-10 mb-100`, "href": `/ink/docs/developer-tools.html` }, "38": { "class": `tx-primary tx-upper tx-30 py-20` }, "39": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "40": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "41": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "42": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "43": { "class": `block py-20`, "title": `Basic Example` }, "44": { "class": `flex bg-white lg-block` }, "45": { "numbers": true, "trim": true, "detab": 16, "class": `basis-half` }, "46": { "class": `basis-half` }, "49": { "p": true, "trim": true, "class": `tx-lh-36 py-20` }, "50": { "title": `Transpiler Example`, "class": `py-20` }, "51": { "class": `flex bg-h-EFEFEF h-full lg-block` }, "52": { "class": `basis-half scroll-auto`, "scroll": true, "numbers": true, "ltrim": true, "detab": 16 }, "53": { "class": `basis-half h-full b-t-1 b-solid by-0 bl-1 br-0 lg-bl-0 lg-bt-1 lg-pt-10 lg-h-auto scroll-auto`, "lang": `js`, "trim": true, "scroll": true, "detab": 16 }, "54": { "class": `flex` }, "55": { "class": `flex-grow tx-right tx-primary py-40`, "href": `/ink/docs/getting-started.html` }, "56": { "name": `chevron-right`, "theme": `tx-1` }, "57": { "class": `foot` } };
  ...
  var BUILD_ID = "0b3ab3d2828fb97c62ce";
