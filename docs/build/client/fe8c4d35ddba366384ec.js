...
`,!1),Vt.default.createElement("article",{class:"block p-10 tx-t-1"},[...this._toNodeList((0,st.children)())]).element]}};var Se=v(F()),Ur=v(I()),at=v(Y()),le=class extends Ur.default{static id="6db660ec31ca715d7e96";static tagname="head";static classname="Head_6db660ec31ca715d7e96";styles(){return""}template(){return(0,at.classlist)().add("absolute","top-0","right-0","left-170","h-45","bg-t-0","z-1"),()=>[Se.default.createText(`
...
`,!1)]).element]}};var Me=v(F()),Hr=v(I()),it=v(Y()),ce=class extends Hr.default{static id="d54fe27339c3e65ac735";static tagname="main";static classname="Main_d54fe27339c3e65ac735";styles(){return""}template(){return(0,it.classlist)().add("absolute","top-45","right-0","left-170","bottom-0","bg-black","b-solid","b-t-2","bx-0","bb-0","bt-1"),()=>[Me.default.createText(`
...
`,!1)]).element]}};var S=v(F()),zr=v(I()),lt=v(Y()),ue=class extends zr.default{static id="ab38f0e847e1d047c1a8";static tagname="app";static classname="App_ab38f0e847e1d047c1a8";styles(){return""}template(){let{title:e,height:r}=(0,lt.props)(),a=r?`height:${r}px`:"";return()=>[S.default.createText(`
...
`,!1)]).element]}};var D=v(F()),Wr=v(I()),Zt=v(Gr()),Yr=v(Y()),fe=class extends Wr.default{static id="d21b237295245a3b7d61";static tagname="code";static classname="Code_d21b237295245a3b7d61";styles(){return`:host {
    display: block;
    font-size: 14px;
    line-height: 20px;
  }
