...
`,!1)]).element]}};var Yt=v(j()),qr=v(I()),st=v(V()),ie=class extends qr.default{static id="7e4942547226dfeef0ae";static tagname="docs";static classname="Docs_7e4942547226dfeef0ae";styles(){return""}template(){return(0,st.classlist)().add("block","w-full","h-full","scroll-y-auto","scroll-x-hidden"),()=>[Yt.default.createText(`
`,!1),Yt.default.createElement("article",{class:"block p-10 tx-t-1"},[...this._toNodeList((0,st.children)())]).element]}};var De=v(j()),Ur=v(I()),at=v(V()),le=class extends Ur.default{static id="6db660ec31ca715d7e96";static tagname="head";static classname="Head_6db660ec31ca715d7e96";styles(){return""}template(){return(0,at.classlist)().add("absolute","top-0","right-0","left-170","h-45","bg-t-0","z-1"),()=>[De.default.createText(`
...
`,!1)]).element]}};var Me=v(j()),Hr=v(I()),nt=v(V()),oe=class extends Hr.default{static id="5fb4822ce248e2b6fb4f";static tagname="left";static classname="Left_5fb4822ce248e2b6fb4f";styles(){return""}template(){return(0,nt.classlist)().add("absolute","top-0","bottom-0","left-0","w-170","bg-t-3","b-solid","b-t-2","by-0","bl-0","br-1","z-2"),()=>[Me.default.createText(`
...
`,!1)]).element]}};var D=v(j()),zr=v(I()),lt=v(V()),ue=class extends zr.default{static id="ab38f0e847e1d047c1a8";static tagname="app";static classname="App_ab38f0e847e1d047c1a8";styles(){return""}template(){let{title:e,height:r}=(0,lt.props)(),a=r?`height:${r}px`:"";return()=>[D.default.createText(`
...
`,!1)]).element]}};var S=v(j()),Wr=v(I()),Zt=v(Gr()),Vr=v(V()),fe=class extends Wr.default{static id="d21b237295245a3b7d61";static tagname="code";static classname="Code_d21b237295245a3b7d61";styles(){return`:host {
    display: block;
    font-size: 14px;
    line-height: 20px;
  }
...
`,!1)])]),t.default.createText(`
    ...
    `,!1)]),t.default.createText(`
  `,!1)]),t.default.createText(`
`,!1)])]}},Sa={PanelLayout_e83da818dc31723bcd5d:Q,ElementIcon_75af7664df8b2546e65a:ee,ElementTab_047b9fc58e7239d4a7f8:re,ApiDocs_7e4942547226dfeef0ae:ie,AppHead_6db660ec31ca715d7e96:le,AppLeft_5fb4822ce248e2b6fb4f:oe,AppMain_d54fe27339c3e65ac735:ce,IdeApp_ab38f0e847e1d047c1a8:ue,IdeCode_d21b237295245a3b7d61:fe,I18nTranslate_b1ed083cf3561af1816f:de},Qr={"panel-layout":Q,"element-icon":ee,"element-tab":re,"api-docs":ie,"app-head":le,"app-left":oe,"app-main":ce,"ide-app":ue,"ide-code":fe,"i18n-translate":de},La="c1fe9c8143f6abad8224";ut.default.once("ready",()=>{ft.sync();for(let[s,e]of Object.entries(Qr))customElements.getName(e)||customElements.define(s,e);ut.default.emit("mounted",document.body)});return cs(Da);})();
