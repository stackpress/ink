var InkAPI=(()=>{var oe=Object.create;var _=Object.defineProperty;var fe=Object.getOwnPropertyDescriptor;var pe=Object.getOwnPropertyNames;var ue=Object.getPrototypeOf,de=Object.prototype.hasOwnProperty;var i=(s,t)=>()=>(t||s((t={exports:{}}).exports,t),t.exports),me=(s,t)=>{for(var a in t)_(s,a,{get:t[a],enumerable:!0})},Y=(s,t,a,r)=>{if(t&&typeof t=="object"||typeof t=="function")for(let l of pe(t))!de.call(s,l)&&l!==a&&_(s,l,{get:()=>t[l],enumerable:!(r=fe(t,l))||r.enumerable});return s};var K=(s,t,a)=>(a=s!=null?oe(ue(s)):{},Y(t||!s||!s.__esModule?_(a,"default",{value:s,enumerable:!0}):a,s)),he=s=>Y(_({},"__esModule",{value:!0}),s);var V=i(E=>{"use strict";Object.defineProperty(E,"__esModule",{value:!0});E.status=xe;var Q={CONTINUE:{code:100,status:"Continue"},PROCESSING:{code:102,status:"Processing"},OK:{code:200,status:"OK"},CREATED:{code:201,status:"Created"},ACCEPTED:{code:202,status:"Accepted"},EMPTY:{code:204,status:"No Content"},RESET:{code:205,status:"Reset Content"},PARTIAL:{code:206,status:"Partial Content"},MOVED:{code:301,status:"Moved Permanently"},FOUND:{code:302,status:"Found"},REDIRECT:{code:303,status:"See Other"},CACHE:{code:304,status:"Not Modified"},TEMPORARY:{code:307,status:"Temporary Redirect"},PERMANENT:{code:308,status:"Permanent Redirect"},ABORT:{code:309,status:"Aborted"},BAD_REQUEST:{code:400,status:"Bad Request"},UNAUTHORIZED:{code:401,status:"Unauthorized"},FORBIDDEN:{code:403,status:"Forbidden"},NOT_FOUND:{code:404,status:"Not Found"},BAD_METHOD:{code:405,status:"Method Not Allowed"},NOT_ACCEPTABLE:{code:406,status:"Not Acceptable"},REQUEST_TIMEOUT:{code:408,status:"Request Timeout"},CONFLICT:{code:409,status:"Conflict"},GONE:{code:410,status:"Gone"},LENGTH_REQUIRED:{code:411,status:"Length Required"},TOO_LARGE:{code:413,status:"Payload Too Large"},TOO_LONG:{code:414,status:"URI Too Long"},UNSUPPORTED_TYPE:{code:415,status:"Unsupported Media Type"},BAD_RANGE:{code:416,status:"Range Not Satisfiable"},BAD_EXPECTATION:{code:417,status:"Expectation Failed"},MISDIRECTED:{code:421,status:"Misdirected Request"},UNPROCESSABLE:{code:422,status:"Unprocessable Content"},LOCKED:{code:423,status:"Locked"},BAD_DEPENDENCY:{code:424,status:"Failed Dependency"},UPGRADE_REQUIRED:{code:426,status:"Upgrade Required"},BAD_PRECONDITION:{code:428,status:"Precondition Required"},TOO_MANY:{code:429,status:"Too Many Requests"},HEADER_TOO_LARGE:{code:431,status:"Request Header Fields Too Large"},LEGAL_REASONS:{code:451,status:"Unavailable For Legal Reasons"},ERROR:{code:500,status:"Internal Server Error"},NOT_IMPLEMENTED:{code:501,status:"Not Implemented"},BAD_GATEWAY:{code:502,status:"Bad Gateway"},UNAVAILABLE:{code:503,status:"Service Unavailable"},RESPONSE_TIMEOUT:{code:504,status:"Gateway Timeout"},BAD_VERSION:{code:505,status:"HTTP Version Not Supported"},INSUFFICIENT_STORAGE:{code:507,status:"Insufficient Storage"},INFINITE_LOOP:{code:508,status:"Loop Detected"},NETWORK_AUTHENTICATION_REQUIRED:{code:511,status:"Network Authentication Required"}};E.default=Q;function xe(s){return Object.values(Q).find(t=>t.code===s)}});var N=i(D=>{"use strict";Object.defineProperty(D,"__esModule",{value:!0});var be=V(),O=class s extends Error{static try(t){return{catch:a=>{try{return t()}catch(r){if(r instanceof s)return a(r,r.type);if(r instanceof Error){let l=s.upgrade(r);return a(l,l.type)}else if(typeof r=="string"){let l=s.for(r);return a(l,l.type)}return a(r,"unknown")}}}}static for(t,...a){return a.forEach(function(r){t=t.replace("%s",String(r))}),new this(t)}static forErrors(t){let a=new this("Invalid Parameters");return a.withErrors(t),a}static require(t,a,...r){if(!t){for(let l of r)a=a.replace("%s",l);throw new this(a)}}static upgrade(t,a=500){if(t instanceof s)return t;let r=new this(t.message,a);return r.name=t.name,r.stack=t.stack,r}get code(){return this._code}get end(){return this._end}get errors(){return Object.assign({},this._errors)}get start(){return this._start}get type(){return this._type}constructor(t,a=500){var r;super(t),this._errors={},this._start=0,this._end=0,this.name=this.constructor.name,this._type=this.constructor.name,this._code=a,this._status=((r=(0,be.status)(a))===null||r===void 0?void 0:r.status)||"Unknown"}toJSON(){return JSON.stringify(this.toResponse(),null,2)}toResponse(t=0,a=0){let r={code:this._code,status:this._status,error:this.message,start:this._start,end:this._end,stack:this.trace(t,a)};return Object.keys(this._errors).length>0&&(r.errors=this._errors),r}trace(t=0,a=0){return typeof this.stack!="string"?[]:this.stack.split(`
`).slice(t,a||this.stack.length).map(l=>l.trim()).map(l=>{if(!l.startsWith("at"))return!1;let[f,w,y]=l.split(" ");y||(y=`(${w})`,w="<none>");let[ne,ce,ie]=y.substring(1,y.length-1).split(":");return{method:w,file:ne,line:parseInt(ce)||0,char:parseInt(ie)||0}}).filter(Boolean)}withCode(t){return this._code=t,this}withErrors(t){return this._errors=t,this}withPosition(t,a){return this._start=t,this._end=a,this}};D.default=O});var J=i(u=>{"use strict";var Te=u&&u.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(u,"__esModule",{value:!0});var ge=Te(N()),j=class extends ge.default{};u.default=j});var P=i(A=>{"use strict";Object.defineProperty(A,"__esModule",{value:!0});var L=class{get length(){return this._elements.size}constructor(t=[]){this._elements=new Set,t.forEach(a=>this._elements.add(a))}add(t){this._elements.add(t)}toArray(){return Array.from(this._elements)}toString(){return Array.from(this._elements).filter(Boolean).map(t=>t.toString()).join("")}};A.default=L});var d=i(R=>{"use strict";Object.defineProperty(R,"__esModule",{value:!0});var ke=new Map;R.default=ke});var C=i(M=>{"use strict";Object.defineProperty(M,"__esModule",{value:!0});var S=class{get value(){return this._escape?this._value.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):this._value}constructor(t,a=!1){this._escape=a,this._value=t}toString(){return this.value}};M.default=S});var q=i(m=>{"use strict";var ye=m&&m.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(m,"__esModule",{value:!0});var _e=ye(P()),Ee=["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"],U=class{get attributes(){return this._attributes}get children(){return this._children}get name(){return this._name}get props(){return this._props}constructor(t,a={},r="",l=[]){this._attributes={},this._name=t,this._attributes=a,this._props=r,this._children=new _e.default(l)}toString(){let t=Object.entries(this._attributes),a=t.length>0?" "+t.map(([l,f])=>{if(typeof f=="string"&&!/["<>\n]/.test(f))return`${l}="${f}"`;if(typeof f=="boolean")return f?l:""}).join(" "):"";if(Ee.includes(this._name))return`<${this._name}${a} />`;let r=this._children.toString();return`<${this._name}${a}>${r}</${this._name}>`}};m.default=U});var $=i(h=>{"use strict";var X=h&&h.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(h,"__esModule",{value:!0});var ve=X(C()),z=X(q()),B=class{static render(t){return t.filter(Boolean).map(a=>a.toString()).join("")}static registry(t,a=new Set){return t.forEach(r=>{r instanceof z.default&&(["html","head","body"].includes(r.name)||a.add(r),r.name!=="head"&&r.children.length>0&&this.registry(r.children.toArray(),a))}),a}static createElement(t,a,r,l=[]){return new z.default(t,a,r,l)}static createText(t,a=!0){return new ve.default(t,a)}};h.default=B});var Z=i(x=>{"use strict";var H=x&&x.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(x,"__esModule",{value:!0});var Ie=H(N()),p=H(d()),G=H($()),F=class{bindings(t={}){p.default.set("props",t||{}),p.default.set("env",Object.assign(Object.assign({},process.env||{}),{BUILD_ID:this.id(),APP_DATA:btoa(JSON.stringify(Object.assign(Object.assign({},Object.fromEntries(p.default.entries())),{env:Object.assign(Object.assign({},Object.fromEntries(Object.entries(process.env||{}).filter(l=>l[0].startsWith("PUBLIC_")))),{BUILD_ID:this.id()})})))}));let a=G.default.registry(this.template());return`{ ${Array.from(a.values()).map((l,f)=>l.props!=="{ }"?`'${f}': ${l.props}`:"").filter(l=>l!=="").join(", ")} }`}render(t={}){p.default.set("props",t||{}),p.default.set("env",Object.assign(Object.assign({},process.env||{}),{BUILD_ID:this.id(),APP_DATA:btoa(JSON.stringify(Object.assign(Object.assign({},Object.fromEntries(p.default.entries())),{env:Object.assign(Object.assign({},Object.fromEntries(Object.entries(process.env||{}).filter(l=>l[0].startsWith("PUBLIC_")))),{BUILD_ID:this.id()})})))}));let a=this.template(),r=G.default.render(a).trim();if(!r.toLowerCase().startsWith("<html"))throw Ie.default.for("Document must start with an <html> tag.");return`<!DOCTYPE html>
${r}`}_toNodeList(t){return typeof t=="object"&&typeof t.nodeType=="number"?[t]:Array.isArray(t)&&t.every(a=>typeof a=="object"&&typeof a.nodeType=="number")?t:[G.default.createText(String(t))]}};x.default=F});var ee=i(b=>{"use strict";Object.defineProperty(b,"__esModule",{value:!0});b.InkEmitter=void 0;var v=class{emit(t,a){return this}on(t,a){return this}once(t,a){return this}unbind(t,a){return this}};b.InkEmitter=v;var we=new v;b.default=we});var te=i(T=>{"use strict";var Oe=T&&T.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(T,"__esModule",{value:!0});var De=Oe(d());function Ne(s){let t=De.default.get("env")||{};return s?t[s]||null:t}T.default=Ne});var se=i(g=>{"use strict";var je=g&&g.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(g,"__esModule",{value:!0});g.default=Ae;var Le=je(d());function Ae(){return Le.default.get("props")||{}}});var re=i(c=>{"use strict";var Pe=c&&c.__createBinding||(Object.create?function(s,t,a,r){r===void 0&&(r=a);var l=Object.getOwnPropertyDescriptor(t,a);(!l||("get"in l?!t.__esModule:l.writable||l.configurable))&&(l={enumerable:!0,get:function(){return t[a]}}),Object.defineProperty(s,r,l)}:function(s,t,a,r){r===void 0&&(r=a),s[r]=t[a]}),Re=c&&c.__setModuleDefault||(Object.create?function(s,t){Object.defineProperty(s,"default",{enumerable:!0,value:t})}:function(s,t){s.default=t}),Se=c&&c.__importStar||function(){var s=function(t){return s=Object.getOwnPropertyNames||function(a){var r=[];for(var l in a)Object.prototype.hasOwnProperty.call(a,l)&&(r[r.length]=l);return r},s(t)};return function(t){if(t&&t.__esModule)return t;var a={};if(t!=null)for(var r=s(t),l=0;l<r.length;l++)r[l]!=="default"&&Pe(a,t,r[l]);return Re(a,t),a}}(),o=c&&c.__importDefault||function(s){return s&&s.__esModule?s:{default:s}};Object.defineProperty(c,"__esModule",{value:!0});c.InkText=c.InkException=c.InkEmitter=c.InkElement=c.InkRegistry=c.InkDocument=c.InkCollection=c.props=c.emitter=c.env=c.data=void 0;var Me=o(J());c.InkException=Me.default;var Ce=o(P());c.InkCollection=Ce.default;var Ue=o(Z());c.InkDocument=Ue.default;var qe=o($());c.InkRegistry=qe.default;var Be=o(q());c.InkElement=Be.default;var ae=Se(ee());c.emitter=ae.default;Object.defineProperty(c,"InkEmitter",{enumerable:!0,get:function(){return ae.InkEmitter}});var $e=o(C());c.InkText=$e.default;var Ge=o(d());c.data=Ge.default;var Fe=o(te());c.env=Fe.default;var He=o(se());c.props=He.default});var W=i((ct,le)=>{le.exports={...re()}});var Ye={};me(Ye,{default:()=>I});var e=K(W()),k=K(W());var n=function(s,...t){let a=We(s);for(let r=0;r<t.length;r++)a=a.replace("%s",String(t[r]));return a},We=function(s){return s};var I=class extends e.InkDocument{id(){return"fe8c4d35ddba366384ec"}styles(){return`@ink theme;
  @ink reset;
  @ink fouc-opacity;
  @ink utilities;`}template(){let t="/docs/template-engine.html",a=n("Template Engine - Ink reactive web component template engine."),r=n("How to use Ink as a template engine."),l=()=>{document.getElementsByTagName("panel-layout")[0].toggle("left")};return[e.InkRegistry.createText(`
...
`,!1)])]),e.InkRegistry.createText(`
      `,!1),e.InkRegistry.createElement("main",{},"{ }",[e.InkRegistry.createText(`
        `,!1),e.InkRegistry.createElement("api-docs",{},"{ }",[e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("ide-app",{height:410,title:"My Project"},"{ 'height': 410, 'title': `My Project` }",[e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("app-head",{},"{ }",[e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("div",{class:"flex scroll-x-auto pt-5 pl-5"},"{ 'class': `flex scroll-x-auto pt-5 pl-5` }",[e.InkRegistry.createText(`
                `,!1),e.InkRegistry.createElement("element-tab",{on:!0,class:"relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0",active:"bg-black tx-white",inactive:"bg-t-1 tx-t-1",group:"engine",selector:"#index-ts"},"{ 'on': true, 'class': `relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0`, 'active': `bg-black tx-white`, 'inactive': `bg-t-1 tx-t-1`, 'group': `engine`, 'selector': `#index-ts` }",[e.InkRegistry.createText(`
                  src/index.ts
                `,!1)]),e.InkRegistry.createText(`
                `,!1),e.InkRegistry.createElement("element-tab",{class:"relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0",active:"bg-black tx-white",inactive:"bg-t-1 tx-t-1",group:"engine",selector:"#page-ink"},"{ 'class': `relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0`, 'active': `bg-black tx-white`, 'inactive': `bg-t-1 tx-t-1`, 'group': `engine`, 'selector': `#page-ink` }",[e.InkRegistry.createText(`
                  src/page.ink
                `,!1)]),e.InkRegistry.createText(`
                `,!1),e.InkRegistry.createElement("element-tab",{class:"relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0",active:"bg-black tx-white",inactive:"bg-t-1 tx-t-1",group:"engine",selector:"#package-json"},"{ 'class': `relative ml-2 p-10 ct-sm b-solid b-t-1 bx-1 bt-1 bb-0`, 'active': `bg-black tx-white`, 'inactive': `bg-t-1 tx-t-1`, 'group': `engine`, 'selector': `#package-json` }",[e.InkRegistry.createText(`
                  package.json
                `,!1)]),e.InkRegistry.createText(`
              `,!1)]),e.InkRegistry.createText(`
            `,!1)]),e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("app-left",{},"{ }",[e.InkRegistry.createText(`
              ...
              `,!1)]),e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("element-tab",{on:!0,class:"pl-15 pt-10 block",active:"tx-white",inactive:"tx-muted",group:"engine",selector:"#index-ts"},"{ 'on': true, 'class': `pl-15 pt-10 block`, 'active': `tx-white`, 'inactive': `tx-muted`, 'group': `engine`, 'selector': `#index-ts` }",[e.InkRegistry.createText(`
                `,!1),e.InkRegistry.createElement("element-icon",{name:"file"},"{ 'name': `file` }"),e.InkRegistry.createText(`
                index.ts
              `,!1)]),e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("element-tab",{class:"pl-15 pt-10 block",active:"tx-white",inactive:"tx-muted",group:"engine",selector:"#page-ink"},"{ 'class': `pl-15 pt-10 block`, 'active': `tx-white`, 'inactive': `tx-muted`, 'group': `engine`, 'selector': `#page-ink` }",[e.InkRegistry.createText(`
                `,!1),e.InkRegistry.createElement("element-icon",{name:"file"},"{ 'name': `file` }"),e.InkRegistry.createText(`
                page.ink
              `,!1)]),e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("element-tab",{class:"pt-10 block",active:"tx-white",inactive:"tx-muted",group:"engine",selector:"#package-json"},"{ 'class': `pt-10 block`, 'active': `tx-white`, 'inactive': `tx-muted`, 'group': `engine`, 'selector': `#package-json` }",[e.InkRegistry.createText(`
                `,!1),e.InkRegistry.createElement("element-icon",{name:"file"},"{ 'name': `file` }"),e.InkRegistry.createText(`
                package.json
              `,!1)]),e.InkRegistry.createText(`
            `,!1)]),e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("app-main",{},"{ }",[e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("ide-code",{id:"index-ts",lang:"js",numbers:!0,trim:!0,detab:16},"{ 'id': `index-ts`, 'lang': `js`, 'numbers': true, 'trim': true, 'detab': 16 }",[...this._toNodeList(`
                ...
                server.listen(3000);
              `)]),e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("ide-code",{id:"page-ink",style:"display:none",numbers:!0,trim:!0,detab:16},"{ 'id': `page-ink`, 'style': `display:none`, 'numbers': true, 'trim': true, 'detab': 16 }",[...this._toNodeList(`
                <style>
              ...
              `,!1),e.InkRegistry.createElement("ide-code",{id:"package-json",style:"display:none",lang:"js",numbers:!0,trim:!0,detab:16},"{ 'id': `package-json`, 'style': `display:none`, 'lang': `js`, 'numbers': true, 'trim': true, 'detab': 16 }",[...this._toNodeList(`
                {
                  ...
                  "dependencies": {
                    "@stackpress/ink": "0.3.11"
                  },
                  "devDependencies": {
                    "@stackpress/ink-dev": "0.3.11",
                    "@types/node": "22.1.0",
                    "ts-node": "10.9.2",
                    "typescript": "5.5.4"
                  }
          ...
          `,!1)]),e.InkRegistry.createText(`
          `,!1),e.InkRegistry.createElement("ide-code",{trim:!0,lang:"bash"},"{ 'trim': true, 'lang': `bash` }",[e.InkRegistry.createText(`
            npm run dev
          `,!1)]),e.InkRegistry.createText(`
          `,!1),e.InkRegistry.createElement("i18n-translate",{p:!0,trim:!0,class:"tx-lh-36 py-20"},"{ 'p': true, 'trim': true, 'class': `tx-lh-36 py-20` }",[e.InkRegistry.createText(`
            Load 
          ...
          `,!1),e.InkRegistry.createElement("nav",{class:"flex"},"{ 'class': `flex` }",[e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("a",{class:"tx-primary py-40",href:"/ink/docs/client-api.html"},"{ 'class': `tx-primary py-40`, 'href': `/ink/docs/client-api.html` }",[e.InkRegistry.createText(`
              ...
              `,!1),...this._toNodeList(n("Client API")),e.InkRegistry.createText(`
            `,!1)]),e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("a",{class:"flex-grow tx-right tx-primary py-40",href:"/ink/docs/single-page.html"},"{ 'class': `flex-grow tx-right tx-primary py-40`, 'href': `/ink/docs/single-page.html` }",[e.InkRegistry.createText(`
              `,!1),...this._toNodeList(n("Single Page App")),e.InkRegistry.createText(`
