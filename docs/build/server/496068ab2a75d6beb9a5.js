var InkAPI=(()=>{var oe=Object.create;var k=Object.defineProperty;var ue=Object.getOwnPropertyDescriptor;var fe=Object.getOwnPropertyNames;var me=Object.getPrototypeOf,pe=Object.prototype.hasOwnProperty;var n=(a,t)=>()=>(t||a((t={exports:{}}).exports,t),t.exports),de=(a,t)=>{for(var r in t)k(a,r,{get:t[r],enumerable:!0})},W=(a,t,r,s)=>{if(t&&typeof t=="object"||typeof t=="function")for(let c of fe(t))!pe.call(a,c)&&c!==r&&k(a,c,{get:()=>t[c],enumerable:!(s=ue(t,c))||s.enumerable});return a};var V=(a,t,r)=>(r=a!=null?oe(me(a)):{},W(t||!a||!a.__esModule?k(r,"default",{value:a,enumerable:!0}):r,a)),xe=a=>W(k({},"__esModule",{value:!0}),a);var O=n(I=>{"use strict";Object.defineProperty(I,"__esModule",{value:!0});var w=class{get length(){return this._elements.size}constructor(t=[]){this._elements=new Set,t.forEach(r=>this._elements.add(r))}add(t){this._elements.add(t)}toArray(){return Array.from(this._elements)}toString(){return Array.from(this._elements).filter(Boolean).map(t=>t.toString()).join("")}};I.default=w});var z=n(_=>{"use strict";Object.defineProperty(_,"__esModule",{value:!0});_.getStatus=he;var J={CONTINUE:{code:100,status:"Continue"},PROCESSING:{code:102,status:"Processing"},OK:{code:200,status:"OK"},CREATED:{code:201,status:"Created"},ACCEPTED:{code:202,status:"Accepted"},EMPTY:{code:204,status:"No Content"},RESET:{code:205,status:"Reset Content"},PARTIAL:{code:206,status:"Partial Content"},MOVED:{code:301,status:"Moved Permanently"},FOUND:{code:302,status:"Found"},REDIRECT:{code:303,status:"See Other"},CACHE:{code:304,status:"Not Modified"},TEMPORARY:{code:307,status:"Temporary Redirect"},PERMANENT:{code:308,status:"Permanent Redirect"},ABORT:{code:309,status:"Aborted"},BAD_REQUEST:{code:400,status:"Bad Request"},UNAUTHORIZED:{code:401,status:"Unauthorized"},FORBIDDEN:{code:403,status:"Forbidden"},NOT_FOUND:{code:404,status:"Not Found"},BAD_METHOD:{code:405,status:"Method Not Allowed"},NOT_ACCEPTABLE:{code:406,status:"Not Acceptable"},REQUEST_TIMEOUT:{code:408,status:"Request Timeout"},CONFLICT:{code:409,status:"Conflict"},GONE:{code:410,status:"Gone"},LENGTH_REQUIRED:{code:411,status:"Length Required"},TOO_LARGE:{code:413,status:"Payload Too Large"},TOO_LONG:{code:414,status:"URI Too Long"},UNSUPPORTED_TYPE:{code:415,status:"Unsupported Media Type"},BAD_RANGE:{code:416,status:"Range Not Satisfiable"},BAD_EXPECTATION:{code:417,status:"Expectation Failed"},MISDIRECTED:{code:421,status:"Misdirected Request"},UNPROCESSABLE:{code:422,status:"Unprocessable Content"},LOCKED:{code:423,status:"Locked"},BAD_DEPENDENCY:{code:424,status:"Failed Dependency"},UPGRADE_REQUIRED:{code:426,status:"Upgrade Required"},BAD_PRECONDITION:{code:428,status:"Precondition Required"},TOO_MANY:{code:429,status:"Too Many Requests"},HEADER_TOO_LARGE:{code:431,status:"Request Header Fields Too Large"},LEGAL_REASONS:{code:451,status:"Unavailable For Legal Reasons"},ERROR:{code:500,status:"Internal Server Error"},NOT_IMPLEMENTED:{code:501,status:"Not Implemented"},BAD_GATEWAY:{code:502,status:"Bad Gateway"},UNAVAILABLE:{code:503,status:"Service Unavailable"},RESPONSE_TIMEOUT:{code:504,status:"Gateway Timeout"},BAD_VERSION:{code:505,status:"HTTP Version Not Supported"},INSUFFICIENT_STORAGE:{code:507,status:"Insufficient Storage"},INFINITE_LOOP:{code:508,status:"Loop Detected"},NETWORK_AUTHENTICATION_REQUIRED:{code:511,status:"Network Authentication Required"}};_.default=J;function he(a){return Object.values(J).find(t=>t.code===a)}});var K=n(S=>{"use strict";Object.defineProperty(S,"__esModule",{value:!0});var Te=z(),C=class a extends Error{static for(t,...r){return r.forEach(function(s){t=t.replace("%s",String(s))}),new this(t)}static forErrors(t){let r=new this("Invalid Parameters");return r.withErrors(t),r}static require(t,r,...s){if(!t){for(let c of s)r=r.replace("%s",c);throw new this(r)}}static try(t){return{catch:r=>{try{return t()}catch(s){if(s instanceof a)return r(s,s.type);if(s instanceof Error){let c=a.upgrade(s);return r(c,c.type)}else if(typeof s=="string"){let c=a.for(s);return r(c,c.type)}return r(s,"unknown")}}}}static upgrade(t,r=500){if(t instanceof a)return t;let s=new this(t.message,r);return s.name=t.name,s.stack=t.stack,s}get code(){return this._code}get end(){return this._end}get errors(){return Object.assign({},this._errors)}get start(){return this._start}get type(){return this._type}constructor(t,r=500){var s;super(t),this._errors={},this._start=0,this._end=0,this.name=this.constructor.name,this._type=this.constructor.name,this._code=r,this._status=((s=(0,Te.getStatus)(r))===null||s===void 0?void 0:s.status)||"Unknown"}toJSON(){return JSON.stringify(this.toResponse(),null,2)}toResponse(t=0,r=0){let s={code:this._code,status:this._status,error:this.message,start:this._start,end:this._end,stack:this.trace(t,r)};return Object.keys(this._errors).length>0&&(s.errors=this._errors),s}trace(t=0,r=0){return typeof this.stack!="string"?[]:this.stack.split(`
`).slice(t,r||this.stack.length).map(c=>c.trim()).map(c=>{if(!c.startsWith("at"))return!1;let[o,f,m]=c.split(" ");m||(m=`(${f})`,f="<none>");let[ce,ie,ne]=m.substring(1,m.length-1).split(":");return{method:f,file:ce,line:parseInt(ie)||0,char:parseInt(ne)||0}}).filter(Boolean)}withCode(t){return this._code=t,this}withErrors(t){return this._errors=t,this}withPosition(t,r){return this._start=t,this._end=r,this}};S.default=C});var A=n(d=>{"use strict";var be=d&&d.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(d,"__esModule",{value:!0});var ye=be(K()),D=class extends ye.default{};d.default=D});var x=n(j=>{"use strict";Object.defineProperty(j,"__esModule",{value:!0});var Ee=new Map;j.default=Ee});var R=n(P=>{"use strict";Object.defineProperty(P,"__esModule",{value:!0});var M=class{get value(){return this._escape?this._value.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"):this._value}constructor(t,r=!1){this._escape=r,this._value=t}toString(){return this.value}};P.default=M});var q=n(h=>{"use strict";var ge=h&&h.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(h,"__esModule",{value:!0});var ke=ge(O()),_e=["area","base","br","col","embed","hr","img","input","link","meta","param","source","track","wbr"],U=class{get attributes(){return this._attributes}get children(){return this._children}get name(){return this._name}get props(){return this._props}constructor(t,r={},s="",c=[]){this._attributes={},this._name=t,this._attributes=r,this._props=s,this._children=new ke.default(c)}toString(){let t=Object.entries(this._attributes),r=t.length>0?" "+t.map(([c,o])=>{if(typeof o=="string"&&!/["<>\n]/.test(o))return`${c}="${o}"`;if(typeof o=="boolean")return o?c:""}).join(" "):"";if(_e.includes(this._name))return`<${this._name}${r} />`;let s=this._children.toString();return`<${this._name}${r}>${s}</${this._name}>`}};h.default=U});var F=n(T=>{"use strict";var X=T&&T.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(T,"__esModule",{value:!0});var Ne=X(R()),Q=X(q()),B=class{static render(t){return t.filter(Boolean).map(r=>r.toString()).join("")}static registry(t,r=new Set){return t.forEach(s=>{s instanceof Q.default&&(["html","head","body"].includes(s.name)||r.add(s),s.name!=="head"&&s.children.length>0&&this.registry(s.children.toArray(),r))}),r}static createElement(t,r,s,c=[]){return new Q.default(t,r,s,c)}static createText(t,r=!0){return new Ne.default(t,r)}};T.default=B});var Z=n(b=>{"use strict";var H=b&&b.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(b,"__esModule",{value:!0});var Le=H(A()),p=H(x()),G=H(F()),$=class{bindings(t={}){p.default.set("props",t||{});let r=Object.fromEntries(Object.entries(process.env||{}).filter(o=>o[0].startsWith("PUBLIC_")));p.default.set("env",Object.assign(Object.assign({},r),{BUILD_ID:this.id()}));let s=G.default.registry(this.template()),c={};return Array.from(s.values()).forEach((o,f)=>{c[String(f)]=o.attributes}),c}render(t={}){p.default.set("props",t||{}),p.default.set("bindings",this.bindings(t));let r=Object.fromEntries(Object.entries(process.env||{}).filter(m=>m[0].startsWith("PUBLIC_")));p.default.set("env",Object.assign(Object.assign({},r),{BUILD_ID:this.id()}));let s=this.template(),c=G.default.render(s).trim();if(!c.toLowerCase().startsWith("<html"))throw Le.default.for("Document must start with an <html> tag.");let o=Object.fromEntries(p.default.entries()),f=JSON.stringify(o).replace(/\n/g,`
  `);return`<!DOCTYPE html>
${c.replace("__CLIENT_DATA__",f)}`}_toNodeList(t){return typeof t=="object"&&typeof t.nodeType=="number"?[t]:Array.isArray(t)&&t.every(r=>typeof r=="object"&&typeof r.nodeType=="number")?t:[G.default.createText(String(t))]}};b.default=$});var ee=n(y=>{"use strict";Object.defineProperty(y,"__esModule",{value:!0});y.InkEmitter=void 0;var N=class{emit(t,r){return this}on(t,r){return this}once(t,r){return this}unbind(t,r){return this}};y.InkEmitter=N;var ve=new N;y.default=ve});var te=n(E=>{"use strict";var we=E&&E.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(E,"__esModule",{value:!0});var Ie=we(x());function Oe(a){let t=Ie.default.get("env")||{};return a?t[a]||null:t}E.default=Oe});var ae=n(g=>{"use strict";var Ce=g&&g.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(g,"__esModule",{value:!0});g.default=De;var Se=Ce(x());function De(){return Se.default.get("props")||{}}});var se=n(i=>{"use strict";var Ae=i&&i.__createBinding||(Object.create?function(a,t,r,s){s===void 0&&(s=r);var c=Object.getOwnPropertyDescriptor(t,r);(!c||("get"in c?!t.__esModule:c.writable||c.configurable))&&(c={enumerable:!0,get:function(){return t[r]}}),Object.defineProperty(a,s,c)}:function(a,t,r,s){s===void 0&&(s=r),a[s]=t[r]}),je=i&&i.__setModuleDefault||(Object.create?function(a,t){Object.defineProperty(a,"default",{enumerable:!0,value:t})}:function(a,t){a.default=t}),Me=i&&i.__importStar||function(){var a=function(t){return a=Object.getOwnPropertyNames||function(r){var s=[];for(var c in r)Object.prototype.hasOwnProperty.call(r,c)&&(s[s.length]=c);return s},a(t)};return function(t){if(t&&t.__esModule)return t;var r={};if(t!=null)for(var s=a(t),c=0;c<s.length;c++)s[c]!=="default"&&Ae(r,t,s[c]);return je(r,t),r}}(),u=i&&i.__importDefault||function(a){return a&&a.__esModule?a:{default:a}};Object.defineProperty(i,"__esModule",{value:!0});i.InkText=i.InkException=i.InkEmitter=i.InkElement=i.InkRegistry=i.InkDocument=i.InkCollection=i.props=i.emitter=i.env=i.data=void 0;var Pe=u(O());i.InkCollection=Pe.default;var Re=u(Z());i.InkDocument=Re.default;var Ue=u(F());i.InkRegistry=Ue.default;var qe=u(q());i.InkElement=qe.default;var re=Me(ee());i.emitter=re.default;Object.defineProperty(i,"InkEmitter",{enumerable:!0,get:function(){return re.InkEmitter}});var Be=u(R());i.InkText=Be.default;var Fe=u(x());i.data=Fe.default;var Ge=u(te());i.env=Ge.default;var $e=u(ae());i.props=$e.default;var He=u(A());i.InkException=He.default});var Y=n((it,le)=>{le.exports={...se()}});var We={};de(We,{default:()=>v});var e=V(Y()),L=V(Y());var l=function(a,...t){let r=Ye(a);for(let s=0;s<t.length;s++)r=r.replace("%s",String(t[s]));return r},Ye=function(a){return a};var v=class extends e.InkDocument{id(){return"496068ab2a75d6beb9a5"}styles(){return`@ink theme;
  @ink reset;
  @ink fouc-opacity;
  @ink utilities;`}template(){let t="/docs/markup-syntax.html",r=l("Markup Syntax - Ink reactive web component template engine."),s=l("Learn how to write markup in Ink."),c=()=>{document.getElementsByTagName("panel-layout")[0].toggle("left")};return[e.InkRegistry.createText(`
`,!1),e.InkRegistry.createElement("html",{},"{ }",[e.InkRegistry.createText(`
  ...
  `,!1),e.InkRegistry.createElement("link",{rel:"stylesheet",type:"text/css",href:`/ink/build/client/${(0,L.env)("BUILD_ID")}.css`},'{ "rel": "stylesheet", "type": "text/css", "href": `/ink/build/client/${env(\'BUILD_ID\')}.css` }'),e.InkRegistry.createElement("script",{id:"CLIENT_DATA",type:"text/json"},'{ "id": "CLIENT_DATA", "type": "text/json" }',[e.InkRegistry.createText("__CLIENT_DATA__",!0)]),e.InkRegistry.createText(`
  `,!1),e.InkRegistry.createElement("script",{type:"text/javascript",src:`/ink/build/client/${(0,L.env)("BUILD_ID")}.js`},'{ "type": "text/javascript", "src": `/ink/build/client/${env(\'BUILD_ID\')}.js` }'),e.InkRegistry.createText(`
  `,!1),...(0,L.env)("PUBLIC_ENV")==="development"?[e.InkRegistry.createElement("script",{src:"/dev.js"},'{ "src": "/dev.js" }')]:[],e.InkRegistry.createText(`
      ...
      `,!1),e.InkRegistry.createElement("aside",{right:!0},'{ "right": true }',[e.InkRegistry.createText(`
        `,!1),e.InkRegistry.createElement("menu",{class:"m-0 px-10 py-20 h-calc-full-40 bg-t-2 scroll-auto"},'{ "class": "m-0 px-10 py-20 h-calc-full-40 bg-t-2 scroll-auto" }',[e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("nav",{class:"tx-14 tx-lh-32"},'{ "class": "tx-14 tx-lh-32" }',[e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-0",href:"#imports"},'{ "class": "block tx-t-0", "href": "#imports" }',[...this._toNodeList(l("Imports"))]),e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-0",href:"#styles"},'{ "class": "block tx-t-0", "href": "#styles" }',[...this._toNodeList(l("Styles"))]),e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-0",href:"#scripts"},'{ "class": "block tx-t-0", "href": "#scripts" }',[...this._toNodeList(l("Scripts"))]),e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-0",href:"#markup"},'{ "class": "block tx-t-0", "href": "#markup" }',[...this._toNodeList(l("Markup"))]),e.InkRegistry.createText(`
            `,!1),e.InkRegistry.createElement("nav",{class:"pl-20"},'{ "class": "pl-20" }',[e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-1",href:"#tagnames"},'{ "class": "block tx-t-1", "href": "#tagnames" }',[...this._toNodeList(l("Tag Names"))]),e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-1",href:"#attributes"},'{ "class": "block tx-t-1", "href": "#attributes" }',[...this._toNodeList(l("Attributes"))]),e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-1",href:"#conditionals"},'{ "class": "block tx-t-1", "href": "#conditionals" }',[...this._toNodeList(l("Conditionals"))]),e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-1",href:"#iterations"},'{ "class": "block tx-t-1", "href": "#iterations" }',[...this._toNodeList(l("Iterations"))]),e.InkRegistry.createText(`
              `,!1),e.InkRegistry.createElement("a",{class:"block tx-t-1",href:"#trycatch"},'{ "class": "block tx-t-1", "href": "#trycatch" }',[...this._toNodeList(l("Try/Catch"))]),e.InkRegistry.createText(`
            `,!1)]),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
        `,!1)]),e.InkRegistry.createText(`
      `,!1)]),e.InkRegistry.createText(`
      `,!1),e.InkRegistry.createElement("main",{},"{ }",[e.InkRegistry.createText(`
        `,!1),e.InkRegistry.createElement("api-docs",{},"{ }",[e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h2",{class:"tx-primary tx-upper tx-26 pt-40 pb-10 mb-20 b-solid b-t-1 bb-1 bt-0 bx-0"},'{ "class": "tx-primary tx-upper tx-26 pt-40 pb-10 mb-20 b-solid b-t-1 bb-1 bt-0 bx-0" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Imports")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h2",{class:"tx-primary tx-upper tx-26 pt-40 pb-10 mb-20 b-solid b-t-1 bb-1 bt-0 bx-0"},'{ "class": "tx-primary tx-upper tx-26 pt-40 pb-10 mb-20 b-solid b-t-1 bb-1 bt-0 bx-0" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Styles")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h2",{class:"tx-primary tx-upper tx-26 pt-40 pb-10 mb-20 b-solid b-t-1 bb-1 bt-0 bx-0"},'{ "class": "tx-primary tx-upper tx-26 pt-40 pb-10 mb-20 b-solid b-t-1 bb-1 bt-0 bx-0" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Scripts")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h2",{class:"tx-primary tx-upper tx-26 pt-40 pb-10 mb-20 b-solid b-t-1 bb-1 bt-0 bx-0"},'{ "class": "tx-primary tx-upper tx-26 pt-40 pb-10 mb-20 b-solid b-t-1 bb-1 bt-0 bx-0" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Markup")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h3",{class:"tx-t-1 tx-upper tx-22 pt-40 pb-20"},'{ "class": "tx-t-1 tx-upper tx-22 pt-40 pb-20" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Tag Names")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h3",{class:"tx-t-1 tx-upper tx-22 pt-40 pb-20"},'{ "class": "tx-t-1 tx-upper tx-22 pt-40 pb-20" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Attributes")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h3",{class:"tx-t-1 tx-upper tx-22 pt-40 pb-20"},'{ "class": "tx-t-1 tx-upper tx-22 pt-40 pb-20" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Conditionals")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h3",{class:"tx-t-1 tx-upper tx-22 pt-40 pb-20"},'{ "class": "tx-t-1 tx-upper tx-22 pt-40 pb-20" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Iterations")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
          ...
          `,!1),e.InkRegistry.createElement("h3",{class:"tx-t-1 tx-upper tx-22 pt-40 pb-20"},'{ "class": "tx-t-1 tx-upper tx-22 pt-40 pb-20" }',[e.InkRegistry.createText(`
            `,!1),...this._toNodeList(l("Try/Catch")),e.InkRegistry.createText(`
          `,!1)]),e.InkRegistry.createText(`
