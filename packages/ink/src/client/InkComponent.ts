...
export default abstract class InkComponent extends HTMLElement {
  ...
  public get element(): InkElement {
    ...
    if (!InkRegistry.has(this)) {
      //it should have...
      throw InkException.for(
        'Component %s not mapped.', 
        this.metadata.classname
      );
    }
    return InkRegistry.get(this) as InkElement;
  }
  ...
  public constructor() {
    ...
    if (!InkRegistry.has(this)) {
      ...
      InkRegistry.register(this, attributes);
    }
  }
  ...
  public cloneElement(element: Element, andChildren = false) {
    return InkRegistry.cloneElement(element, andChildren);
  }
  ...
  public getElement(element: Element) {
    return InkRegistry.get(element);
  }
  ...
  public getParentComponent() {
    ...
    while (parent) {
      if (parent instanceof InkComponent) {
        return parent;
      }
  ...
  public register(attributes: Hash = {}, children: AnyChild[] = []) {
    ...
    if (InkRegistry.has(this)) {
      ...
      const element = InkRegistry.get(this) as InkElement;
