...
//this is what is returned by the Ink parser
export type AST = {
  imports: ImportToken[];
...
export type BuildResults = {
  source: string,
  InkDocument: ServerDocumentClass,
...
//ie. (e) => {}
export type InkBrowserEvent<T = undefined> = Event & {
  detail?: T;
};
//for signals
...
export type InkCompiler = {
  ...
  use(plugin: (compiler: InkCompiler) => void): InkCompiler,
