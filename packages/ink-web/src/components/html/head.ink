<head>
  ...
  <title>{title}</title>
  <meta name="url" property="og:url" content={`https://stackpress.github.io/ink${url}`} />
  <meta name="type" property="og:type" content="website" />
  <meta name="image" property="og:image" content="https://stackpress.github.io/ink/ink-logo.png" />
  ...
  <script type="text/javascript" src={`/ink/build/client/${env('BUILD_ID')}.js`}></script>
